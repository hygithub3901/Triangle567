...
class TestTriangles(unittest.TestCase):
    ...
    def testInvalidInputA(self):
        self.assertEqual(classifyTriangle(300, 300, 300), 'InvalidInput', '(300, 300, 300) is InvalidInput')

    def testInvalidInputB(self):
        self.assertEqual(classifyTriangle(-1, 0, 0), 'InvalidInput', '(-1, 0, 0) is InvalidInput')

    def testInvalidInputC(self):
        self.assertEqual(classifyTriangle("a", "b", "c"), 'InvalidInput', '("a", "b", "c") is InvalidInput')

    def testNotATriangleA(self):
        self.assertEqual(classifyTriangle(1, 1, 10), 'NotATriangle', '(1, 1, 10) is InvalidInput')
    ...
    def testIsocelesTrianglesC(self):
        self.assertEqual(classifyTriangle(2, 1, 2), 'Isoceles', '1,2,2 should be Isoceles')
